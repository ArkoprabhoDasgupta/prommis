...
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "H2O"].fix(1e6)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "H"].fix(
    10.75
)  # decision variable
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "SO4"].fix(100)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "HSO4"].fix(1e4)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Al"].fix(422.375)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Ca"].fix(109.542)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Cl"].fix(1e-7)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Fe"].fix(688.266)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Sc"].fix(0.032)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Y"].fix(0.124)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "La"].fix(0.986)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Ce"].fix(2.277)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Pr"].fix(0.303)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Nd"].fix(0.946)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Sm"].fix(0.097)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Gd"].fix(0.2584)
m.fs.mixer_settler_sx[:].aqueous_inlet.conc_mass_comp[0, "Dy"].fix(0.047)
...
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Ca_o"].fix(2.684e-5)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Fe_o"].fix(2.873e-6)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Sc_o"].fix(1.734)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Y_o"].fix(2.179e-5)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "La_o"].fix(0.000105)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Ce_o"].fix(0.00031)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Pr_o"].fix(3.711e-5)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Nd_o"].fix(0.000165)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Sm_o"].fix(1.701e-5)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Gd_o"].fix(3.357e-5)
m.fs.mixer_settler_sx[:].organic_inlet.conc_mass_comp[0, "Dy_o"].fix(8.008e-6)

m.fs.mixer_settler_sx[:].organic_inlet.flow_vol.fix(62.01)
...
msx_initializer = MixerSettlerExtractionInitializer()
for s in stage_list:
    msx_initializer.initialize(m.fs.mixer_settler_sx[s])

m.fs.mixer_settler_sx[2].aqueous_inlet.unfix()
m.fs.mixer_settler_sx[1].organic_inlet.unfix()
