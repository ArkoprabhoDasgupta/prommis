...
df_alpha_1M_HCl = pd.read_excel(data_path, sheet_name="1 M HCl alpha values alt")
df_alpha_3M_HCl = pd.read_excel(data_path, sheet_name="3 M HCl alpha values alt")
df_alpha_5M_HCl = pd.read_excel(data_path, sheet_name="5 M HCl alpha values alt")
...
df_alpha = pd.read_excel(data_path, sheet_name="All HCl data alt")
