...
m.fs.membrane_module.feed_phase_inlet.flow_vol.fix(17 * units.L / units.hr)
...
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "La"].fix(273)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Ce"].fix(573)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Pr"].fix(70)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Nd"].fix(315)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Sm"].fix(65.9)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Gd"].fix(67.5)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Dy"].fix(52.4)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Y"].fix(231)
m.fs.membrane_module.feed_phase_inlet.conc_mass_comp[0, "Sc"].fix(20)
...
m.fs.membrane_module.strip_phase_inlet.flow_vol.fix(54 * units.L / units.hr)
...
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Fe"].fix(515)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "La"].fix(1.89)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Ce"].fix(3.19)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Pr"].fix(0.398)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Nd"].fix(1.24)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Sm"].fix(0.15)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Gd"].fix(0.157)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Dy"].fix(0.119)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Y"].fix(0.6)
m.fs.membrane_module.strip_phase_inlet.conc_mass_comp[0, "Sc"].fix(0.649)
