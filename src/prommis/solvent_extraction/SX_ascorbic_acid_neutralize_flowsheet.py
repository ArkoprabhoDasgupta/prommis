...
m.fs.asc_mixer_to_sx = Arc(
    source=m.fs.ascorbic_mixer.outlet, destination=m.fs.mixer_settler_ex.aqueous_inlet
)
...
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "H"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "SO4"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "HSO4"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Cl"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Fe"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Ascorbic"].fix(40 * units.g / units.L)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Y"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "La"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Ce"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Pr"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Nd"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Sm"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Gd"].fix(1e-7)
m.fs.ascorbic_mixer.ascorbic.conc_mass_comp[0, "Dy"].fix(1e-7)
