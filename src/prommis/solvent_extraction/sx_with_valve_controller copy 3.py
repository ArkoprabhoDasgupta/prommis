...
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["H"].fix(49.069)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["SO4"].fix(1725.01)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["HSO4"].fix(8358.062)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Al"].fix(362.132)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Ca"].fix(81.724)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Cl"].fix(1e-7)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Fe"].fix(454.049)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Sc"].fix(1.99e-4)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Y"].fix(2.3e-4)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["La"].fix(0.3931)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Ce"].fix(2.128)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Pr"].fix(0.091)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Nd"].fix(0.886)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Sm"].fix(0.088)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Gd"].fix(0.2055)
m.fs.solex.mscontactor.aqueous[0, :].conc_mass_comp["Dy"].fix(0.0031)
...
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Al"].fix(60.242)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Ca"].fix(27.817)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Fe"].fix(234.216)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Sc"].fix(1.765)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Y"].fix(0.213)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["La"].fix(0.592)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Ce"].fix(0.1490)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Pr"].fix(0.211)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Nd"].fix(0.0593)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Sm"].fix(0.00887)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Gd"].fix(0.0528)
m.fs.solex.mscontactor.organic[0, :].conc_mass_comp["Dy"].fix(0.043)
