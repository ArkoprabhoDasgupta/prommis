...
#     if t <= 10:
#         m.a[t] = (62.01-1)/10
#         return m.fs.solex.mscontactor.organic_inlet_state[t].flow_vol == (1 + m.a[t]*t)
#     else:
#         m.a[t] = 0
...
m.fs.solex.mscontactor.organic[0, :].flow_vol.fix(10)
...
m.fs.solex.mscontactor.organic[time_duration, number_of_stages].conc_mass_comp.display()
m.fs.solex.mscontactor.organic[time_duration, number_of_stages].conc_mol_comp.display()
